...
export default class Icon extends Component {
  render () {
    ...
    return <svg {...restProps} version="1.1" viewBox="0 0 24 24" width="24px" height="24px" role="img" className={classes} aria-label={a11yTitle}><polygon fill="none" stroke="#000" strokeWidth="2" points="3 11 11 13 13 21 21 3"/></svg>;
  }
};
